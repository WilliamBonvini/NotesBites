...
$$
\text{Bargaining Solution}=f:\textcolor{red}{(S,d)}\textcolor{black}{\to}\textcolor{orange}{(U^a(z),U^b(z)) \in S}
$$

$$\textcolor{red}{Domain}\textcolor{black}{;}\textcolor{orange}{Codomain}$$.
...
S \cap\{(x^a,x^b)|x^a\ge d^a \land x^b \ge d^b\}\ne \emptyset
...
<img src="file:///android_asset/aaams/img/15111.png" style="zoom:40%">  
...
1. <u>Individual Rationality</u>  
   ...
   \textcolor{red}f\textcolor{orange}(S,d)\textcolor{black}\ge d

   $$

   $$\textcolor{red}\text{Bargaining Solution}\textcolor{black};	\textcolor{orange}\text{Bargaining Problem}$$.  
...
5. <u>Independence of irrelevant alternatives</u>  
   ...
   <img src="file:///android_asset/aaams/img/15112.png" style="zoom:40%"> 

   My result does not depend on what I left out.



The final result is the <mark>Nash Bargaining Solution</mark>:   
...
<img src="file:///android_asset/aaams/img/08111.png" style="zoom:40%">