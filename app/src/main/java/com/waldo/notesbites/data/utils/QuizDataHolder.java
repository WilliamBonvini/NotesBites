...
public class QuizDataHolder {
    public static String AAAMS_1_1 = "What is an agent?\n" +
            ...
            "1";
    public static String AAAMS_1_2 = "How is flexibility summed up?\n" +
    ...
    public static String AAAMS_1_3 = "How can an agent interact with an environment?\n" +
    ...
    public static String AAAMS_2_1 = "What is a reactive agent?\n" +
    ...
    public static String AAAMS_2_2 = "What are the three types of knowledge of an agent?\n" +
            "believe, desire, intention\n" +
            "intention, intuition, desire\n" +
            "desire, intuition, believe\n" +
            "believe, intention, intuition\n" +
            "1";
    public static String AAAMS_2_3 = "What are the three types of knowledge of an agent?\n" +
            "believe, desire, intention\n" +
            "intention, intuition, desire\n" +
            "desire, intuition, believe\n" +
            "believe, intention, intuition\n" +
