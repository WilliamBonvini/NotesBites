package com.waldo.notesbites.data.daos;
...
public interface ModuleDao {
    ...
    @Query("SELECT * FROM module_table WHERE belongingSubjectID = :belongingSubjectID and lastOpened IS NOT null ORDER BY lastOpened DESC LIMIT 3")
