...
public abstract class NBDatabase extends RoomDatabase {
    ...
    private static class PopulateDbAsyncTask extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... voids){
            ...
            moduleDao.insert(new Module("introduction to AI","bangarang",1,"### mdContent of intro to AI\nciaaao","www.youtube.com",SUBJECT_NAME));
            moduleDao.insert(new Module("modulo2","bangarang",2,"### mdcontent2\nciaaao","www.youtube.com",SUBJECT_NAME));
            moduleDao.insert(new Module("modulo3","bangarang",3,"### mdContent3","www.youtube.com",SUBJECT_NAME));
            moduleDao.insert(new Module("modulo4","bangarang",4,"### mdContent4","www.youtube.com",SUBJECT_NAME));
            moduleDao.insert(new Module("modulo5","bangarang",5,"### mdContent5 \n ehi","www.youtube.com",SUBJECT_NAME));
